...
# ⭐二、原型设计
## 交互及界面设计：
- 1、启动页：用户引入眼帘的是一个垃圾桶和易扔APP的slogen。<br>  ![易扔APP启动页.png](https://upload-images.jianshu.io/upload_images/9509773-0d49fb9264f2913a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
